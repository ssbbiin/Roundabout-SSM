...
OUT_DIR = ROOT / "outputs/mamba_baseline"
...
print("=" * 100)
print("MAMBA2 BASELINE TRAINING")
print("=" * 100)

print("Device:", DEVICE)

train_ds = RoundaboutTorchDataset(
    split="train",
    history_frames=50,
    max_neighbors=8,
...
test_ds = RoundaboutTorchDataset(
    split="test",
    history_frames=50,
    max_neighbors=8,
    neighbor_radius=30.0,
...
def heading_error_deg(prediction, target):
...
def evaluate(loader):
    ...
    return {
        ...
        "recall": recall,
        "f1": f1,
        "tte_mae": tte_abs / total_samples,
        "speed_mae": speed_abs / total_samples,
        "heading_mae_deg": heading_abs / total_samples,
        "tp": tp,
        "tn": tn,
        "fp": fp,
        "fn": fn,
