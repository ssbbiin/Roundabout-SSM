...
OUT_DIR = ROOT / "outputs/lstm_ego_map"
...
def move_batch(batch):
    ...
    # ====================================================
    # ABLATION:
    # Keep Ego (agent 0) only.
    # All neighbor agents are masked out.
    # Entry-line geometry remains available.
    # ====================================================
    batch["agent_mask"][:, 1:] = 0.0
