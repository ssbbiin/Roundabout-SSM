...
print("=" * 90)
print("MAMBA2 SANITY OVERFIT TEST")
print("=" * 90)
print("Device:", DEVICE)
...
for epoch in range(
    ...
    if (
        stats["accuracy"] >= 0.98
        and stats["tte_mae"] <= 0.25
        and stats["speed_mae"] <= 0.70
    ):

        print()
        print("MAMBA2 SANITY TEST PASSED.")
        print(
